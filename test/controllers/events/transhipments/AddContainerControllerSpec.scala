...
class AddContainerControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  private lazy val addContainerRoute: String = routes.AddContainerController.onPageLoad(mrn, index, NormalMode).url
  ...
  "AddContainer Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers    = UserAnswers(mrn).set(AddContainerPage(index), true).success.value
