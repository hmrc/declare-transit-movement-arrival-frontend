...
class TraderAddressControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val traderAddressRoute = routes.TraderAddressController.onPageLoad(ref, NormalMode).url
