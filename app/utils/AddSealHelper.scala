        ...
        Row(
          ...
          actions = List(
            Action(
              ...
              href               = SealIdentityController.onPageLoad(userAnswers.ref, eventIndex, sealIndex, mode).url,
            ...
            Action(
              ...
              href               = ConfirmRemoveSealController.onPageLoad(userAnswers.ref, eventIndex, sealIndex, mode).url,
