...
echo "GET        /:mrn/consigneeAddress                        controllers.ConsigneeAddressController.onPageLoad(ref: MovementReferenceNumber, mode: Mode = NormalMode)" >> ../conf/app.routes
...
echo "GET        /:mrn/changeConsigneeAddress                  controllers.ConsigneeAddressController.onPageLoad(ref: MovementReferenceNumber, mode: Mode = CheckMode)" >> ../conf/app.routes
...
awk '/class CheckYourAnswersHelper/ {\
     ...
     print "            href               = routes.ConsigneeAddressController.onPageLoad(ref, CheckMode).url,";\
