...
echo "GET        /:mrn/haveSealsChanged                        controllers.HaveSealsChangedController.onPageLoad(mrn: MovementReferenceNumber, mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /:mrn/haveSealsChanged                        controllers.HaveSealsChangedController.onSubmit(mrn: MovementReferenceNumber, mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /:mrn/changeHaveSealsChanged                  controllers.HaveSealsChangedController.onPageLoad(mrn: MovementReferenceNumber, mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /:mrn/changeHaveSealsChanged                  controllers.HaveSealsChangedController.onSubmit(mrn: MovementReferenceNumber, mode: Mode = CheckMode)" >> ../conf/app.routes
